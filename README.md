<div align="center">
  ...
  <h1>Oh My Skills</h1>
  <p><b>macOS 优先的 Agent Skills 工作台</b></p>
</div>
...
- **macOS 原生体验**：使用 Tauri + macOS Private API，窗口半透明、毛玻璃效果
...
- Push / PR 到 `main` 时自动运行前端构建 + Rust 测试
- 后续会添加 release workflow：打 tag 后自动构建 DMG 并发布到 GitHub Releases
