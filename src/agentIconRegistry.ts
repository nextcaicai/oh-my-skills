...
const iconFiles: Record<string, AgentIconAsset> = {
  ...
  codex: { src: new URL("../agent-icons/codex-color.svg", import.meta.url).href },
  ...
  "kilo-code": { src: new URL("../agent-icons/kilocode.svg", import.meta.url).href },
  ...
  pi: { src: new URL("../agent-icons/pi-logo.svg", import.meta.url).href },
  ...
  warp: { src: new URL("../agent-icons/warp-logo-dark.svg", import.meta.url).href },
